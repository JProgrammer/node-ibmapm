...
Metric.prototype.getArrayEL = function getArrayEL() {
    ...
    for (var i in el){
        var el_event = el[i];
        jsonDataArray.push({
            EVENTLOOP_LATENCY_AVG: el_event.latency_avg,
            EVENTLOOP_LATENCY_MIN: el_event.latency_min,
            EVENTLOOP_LATENCY_MAX: el_event.latency_max,
            TIMESTAMP: el_event.timestamp
        });
    }
...
Metric.prototype.getArrayLoop = function getArrayLoop() {
    ...
    for (var i in loop){
        ...
        jsonDataArray.push({
            ...
            TIMESTAMP: loop_event.timestamp
        });
    }
    return jsonDataArray;
};
...
Metric.prototype.getJSONGC = function getJSONGC() {
    ...
    if (totalCount) {
        ...
        jsonGCData = {
            ...
            GC_M_COUNT: this.gc.m_count,
            GC_S_COUNT: this.gc.s_count
        };
    } else {
        jsonGCData = {
            HEAP_SIZE: this.preHeapSize,
...
Metric.prototype.getArrayGC = function getArrayGC() {
    ...
    for (var i in gc){
        ...
        jsonDataArray.push({
            ...
            HEAP_USED: gc_event.heap_used,
            HEAP_SIZE: gc_event.heap_size,
